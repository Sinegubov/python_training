...
testdata = [Contact(firstname="", middlename="", lastname="", nickname="", title="", company="", address="",
    ...
    Contact(firstname=random_string("firstname", 10), middlename="", lastname=random_string("lastname", 10),
            ...
            work_telephone=random_string("work_telephone", 20), fax="", email=random_string_email("email", 20),
            email2=random_string_email("email2", 20), email3=random_string_email("email3", 20), homepage="",
            address_secondary="", phone_home_secondary="", notes="")
    for i in range(n)
]
