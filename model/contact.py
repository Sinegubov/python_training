...
class Contact:
    ...
    def __repr__(self):
        return "%s%s%s%s%s%s%s%s%s%s" % (self.id, self.firstname, self.lastname, self.address, self.home_telephone,
                                         self.mobile_telephone, self.work_telephone, self.email, self.email2,
                                         self.email3)
